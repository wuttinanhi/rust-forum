...
use crate::{
    ...
    services::{comment_service::CommentService, post_service::PostService},
    utils::{
...
impl ActixProfileController {
    ...
    pub async fn users_view_profile_route(
        ...
        let post_service_cloned = self.post_service.clone();
        let comment_service_cloned = self.comment_service.clone();
